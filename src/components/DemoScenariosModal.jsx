              ...
              >
                <div className="flex items-start gap-4">
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-mono font-bold text-sm shrink-0 ${
                    isSelected ? 'bg-amber-500 text-slate-950' : 'bg-white/5 text-slate-400 group-hover:text-amber-400'
                  }`}>
                    0{idx + 1}
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4 text-[11px] text-slate-400 font-mono">
                      <span>Location: <strong className="text-slate-200">{scen.location}</strong></span>
                      <span>Date: <strong className="text-slate-200">{scen.date}</strong></span>
                    </div>
                  </div>
                </div>

                {/* Select Button */}
                <button className={`btn-primary py-2 px-4 text-xs shrink-0 ${isSelected ? 'opacity-100' : 'opacity-80 group-hover:opacity-100'}`}>
